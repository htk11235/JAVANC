...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Login_Button.setBackground(new java.awt.Color(0, 204, 153));
        Login_Button.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Login_Button.setForeground(new java.awt.Color(255, 255, 255));
        Login_Button.setText("Login");
        Login_Button.setMaximumSize(new java.awt.Dimension(100, 40));
        Login_Button.setPreferredSize(new java.awt.Dimension(75, 30));
    ...
    private void Login_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Login_ButtonActionPerformed
        ...
        try {
            if (userService.isLoginUser(user)) {
                ...
                this.dispose();
            } else if (userService.isLoginAdmin(user)) {
